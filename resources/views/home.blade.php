        ...
        <div class="container">
            <div class="row align-items-center min-vh-75 min-vh-lg-100">
                <div class="col-md-7 col-lg-6 col-xxl-5 py-6 text-sm-start text-center">
                    <h1 class="mt-6 mb-sm-4 fw-semi-bold lh-sm fs-4 fs-lg-5 fs-xl-6">MonJaTir<br
                            class="d-block d-lg-block" />(Monitoring Jamur Tiram)</h1>
                    <p class="mb-4 fs-1">
                        Mari monitoring jamur merangmu bersama MonJaTir agar hasil panenmu lebih bagus dan baik
                    </p>
